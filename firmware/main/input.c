...
void input_init(void)
{
    ...
    // joystick present? both axes must rest near mid-scale and sit still
    ...
    jx0 = sx / 16.0f; jy0 = sy / 16.0f;
    has_joy = jx0 > 1000 && jx0 < 3100 && jy0 > 1000 && jy0 < 3100 && maxx - minx < 160 && maxy - miny < 160;
